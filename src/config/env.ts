...
const schema = z.object({
  ...
  // no API key. Weakest model: routed ABSOLUTE LAST when every remote
  // provider and the local fallbacks are exhausted.
  ...
  // to match the agent's 1800s SDK timeout; slow 0.8B prefills need it.
